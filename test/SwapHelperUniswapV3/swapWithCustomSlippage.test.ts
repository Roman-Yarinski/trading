...
import { SWAP_ROUTER, FACTORY, SLIPPAGE, SECONDS_AGO, ZERO_ADDRESS, PRECISION } from "@test-utils";

describe("Method: swapWithCustomSlippage", () => {
  ...
  describe("When one of parameters is incorrect", () => {
    ...
    it("When slippage is to hight", async () => {
      ...
      await expect(
        swapHelperContract.swapWithCustomSlippage(
          beneficiary.address,
          WETH9,
          USDC,
          amountIn,
  ...
  describe("When all parameters correct", () => {
    ...
    before(async () => {
      ...
      result = await swapHelperContract.swapWithCustomSlippage(
        beneficiary.address,
        WETH9,
        USDC,
        amountIn,
